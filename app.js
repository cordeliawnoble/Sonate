(() => {
  ...
  async function deposit() {
    ...
    try {
      ...
      // Apps Script accepte la requête mais ne renvoie pas toujours
      // une réponse lisible par GitHub Pages à cause de CORS.
      // En mode no-cors, on considère l'envoi réseau réussi si fetch
      // ne lève pas d'erreur. Le brouillon reste protégé en cas d'échec réseau.
      clearDraft(false);
