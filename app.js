  ...
  onReady(() => {
    ...
    try {
      ...
      async function postPayload(p){
        ...
        saveStatus.textContent = "Envoi de la note…";
        ...
        // Avec no-cors la réponse est opaque, mais si fetch ne lève pas
        // d'erreur la requête a été envoyée. La vraie confirmation vient
        // ensuite du GET status par ID.
        saveStatus.textContent = "Requête envoyée. Je vérifie Pépinière…";
        return response;
      }
